...
<iframe class="flexdashboard" src="./flexdashboard_sucrose.html" style = "width: 100%; height:95vh;"></iframe>
</div>
...
<!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#testesemoiframe">
  Launch static backdrop modal
</button>

<!-- Modal -->
<div class="modal fade" id="testesemoiframe" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="testesemoiframeLabel" aria-hidden="true">
<div class="modal-dialog modal-xl modal-dialog-centered">
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="testesemoiframeLabel">Modal title</h5>
<button type="button" class="close" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button>
</div>
