...
base::source(file = "../../../R/consumiveis.R", encoding = "UTF-8")
```
...
tags$div(class="alert alert-primary",
         ...
         tags$h4(id="resumo",
                 class="genshin_font",
                 style="padding-top: 90px; margin-top: -90px;",
                 "Resumo"),
         tags$ul(
             ...
             tags$li("Lembre-se de acender a fogueira, e;"),
             tags$li("A fila de processamento é de 99 itens."),
             )
         )
```
