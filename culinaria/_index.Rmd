    ...
    tags$div(id="carouselExampleCaptions",
             ...
             tags$div(class="carousel-inner",
                      tags$div(class="carousel-item active",
                               tags$img(style="content:url('../culinaria/liyue.png'); filter: brightness(0.6); border-radius: 0.25rem;",
                                        class="d-block w-100",
                      ...
                      tags$div(class="carousel-item",
                               tags$img(style="content:url('../culinaria/mondstadt.png'); filter: brightness(0.6); border-radius: 0.25rem;",
                                        class="d-block w-100",
                      ...
                      tags$div(class="carousel-item",
                               tags$img(style="content:url('../culinaria/albergue_wangshu.png'); filter: brightness(0.6); border-radius: 0.25rem;",
                                        class="d-block w-100",
                               ...
                               tags$div(class="carousel-caption d-none d-md-block",
                                        tags$h1(class="genshin_font",
                                                "Albergue Wangshu"))),
                      tags$div(class="carousel-item",
                               tags$img(style="content:url('../culinaria/mondstadt_externo.png'); filter: brightness(0.6); border-radius: 0.25rem;",
                                        class="d-block w-100",
...
resumo_wrapper(
    lista = tags$ul(
             tags$li("Aether e Lumine já começam com 9 pratos em seu portfólio de pratos."),
             tags$li("Os pratos que não precisam de", tags$code("receita") , "possuem efeitos/atributos muito limitados."),
...
Poucos pratos podem ser preparados sem a necessidade de aprender as receitas, antes de prepará-las. Caso queira preparar pratos com atributos mais robustos, terás que aprender a `receita` antes. Você poderá comprar as receitas de ranking menores nos NPC's localizados nas cidades de Mondstadt e Liyue, além de encontrá-las nos baús ou em outras interações com o jogo, tais como recompensas de uma missão.
...
carousel_n_images(
        ...
        # Endereços das imagens.
        url_list = list("../culinaria/6_1_autocook.png",
                        "../culinaria/6_2_autocook.png"),
